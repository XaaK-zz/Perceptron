...
public class ExperimentFour extends ExperimentBase {
	...
	public void execute(String trainingDataPath, String testingDataPath, int digit) {
		...
		this.ReportResults(trainerList, metrics, epochs, "Experiment Four metrics on training data:");
		...
		this.ReportResults(trainerList, metrics, epochs, "Experiment Four metrics on testing data:");
	}
